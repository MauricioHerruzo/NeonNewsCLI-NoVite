<?php include_once('header.php') ?>
    <main class="overflow-x-hidden">
        <!-- carousel noticias  -->
         <a href="post.php" id="bannerA">
        <section id="bannerVideojuegos" class="bg-cover bg-center w-full h-150 md:h-200 content-end  border-b-3 border-(--NeonGrey) lg:h-[90vh] ">
            <div class="w-full fondoBanner lg:p-6">
            <h1 class="px-4 lg:text-6xl">Analizamos el rediseño de Donkey Kong</h1>   
        ...
        <section id="destacados" class =" relative flex flex-col  w-full items-center mt-15">
            ...
            <!-- Carrousel destacados  -->         
                 <a href="post.html" id="destacadoLink">            <div id="destacadoCard" class=" carruselDestacados flex-col bg-(--RellenoTarjetas) sombraTarjetas p-6 w-[95vw] lg:w-auto rounded-4xl border-b-2 border-r-2 border-b-[var(--NintendoRed)] border-r-[var(--NintendoRed)] z-10 lg:flex lg:flex.col lg:justify-center lg:p-10 ">
                <img id="destacadoImage" src="/NeonNewsDefinitivo/img/Nintendo.jpg" alt="Switch 2" class="w-full aspect-video object-cover rounded-2xl mb-2">
                ...
                <div class="info flex items-center gap-1  self-start">
                    <div class="videojuego flex items-center ">
                        ...
                        <img id="destacadoCategoryIcon" src="/NeonNewsDefinitivo/img/Vector.svg" alt="iconoVideojuego" class="size-10 lg:size-15">
                    </div>
                    <!-- icono usuario  -->
                    <div class="relative rounded-full border-1 border-(--NeonBlanco) w-8 h-8 overflow-hidden lg:size-15">
                        <img id="destacadoUserImage" src="/NeonNewsDefinitivo/img/usuario.webp" alt="usuarioIMG" class="w-full h-full object-cover ">
                    </div>
        ...
        </a>        <!-- Navegacion carrouseles categorias destacadas -->
        <div class=" flex bg-(--RellenoTarjetas) rounded-full px-3 py-3 justify-around w-[95vw] sombraTarjetas  lg:w-auto lg:flex-col ">
            <div class="categoriaVideojuego flex justify-center cursor-pointer" data-category="Nintendo" id="categoryNintendo"><img src="/NeonNewsDefinitivo/img/Nintendo.svg" alt="Switch" class="h-10 lg:h-20"></div>
            <div class="categoriaVideojuego flex justify-center cursor-pointer" data-category="Overwatch" id="categoryOverwatch"><img src="/NeonNewsDefinitivo/img/Overwatch.svg" alt="Overwatch"class="h-10 lg:h-20"></div>
            <div class="categoriaVideojuego flex justify-center cursor-pointer" data-category="PC" id="categoryPC"><img src="/NeonNewsDefinitivo/img/PC.svg" alt="La compu"class="h-10 lg:h-20"></div>
            <div class="categoriaVideojuego flex justify-center cursor-pointer" data-category="PlayStation" id="categoryPlayStation"><img src="/NeonNewsDefinitivo/img/Play.svg" alt="Plastation"class="h-10 lg:h-20"></div>
            <div class="categoriaVideojuego flex justify-center cursor-pointer" data-category="LoL" id="categoryLoL"><img src="/NeonNewsDefinitivo/img/LoL.svg" alt="LoLxd" class="h-10 lg:h-20"></div>
         </div>
        </div>
        </section>
...
<?php include_once('footer.php') ?>
    ...
    <script src="../pages/footer.js" type="module"></script>
    <script src="../pages/header.js" type="module"></script>    <script src="../script/main.js"></script>
    <script src="../script/bannerVideojuegos.js"></script>
    ...
    <style>
        /* MAs problemas con JS-TailwindCSS, no se pueden usar variables de CSS en clases de Tailwind,menos mal que alguien acabo inventando los frameworks con prerenderizado */
