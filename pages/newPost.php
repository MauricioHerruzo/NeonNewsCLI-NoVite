...
<?php include_once('footer.php') ?>
    ...
    <style>
        /* Guarrada para ajustar el estilo del wywiwyg */
      ...
      /* ELIMINAR LA FLECHA DEL SELECT DE CATEGORIAS */ 
      select#category {
        appearance: none !important;
        /* la lleva el navegador asi que hay que quitarla y crear la nuestra propia  */
      ...
      /* que dolor de cabeza es el wysiwyg  */
